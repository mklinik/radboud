...
#define CcRqGETCLIPBOARDCOUNT					1809		/* retrieve clipboard count. */
...
#define CcRqDESTROYMENU							1214		/* destroying a menu 'physically' */
#define CcRqDELETEMENU							1213		/* deleting a menu logically */
