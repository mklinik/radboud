...
/*
	...
	AFP 2011
	This implementation contains some errors! (on purpose).
*/
import StdEnv, gast
...
ggen{|Rat|} n r = [{n=n,d=d}\\(n,d)<-diag2 [0:[i\\j<-[1..],i<-[j,~j]]] [1..]|gcd n d==1]
//ggen{|Rat|} s = [{n=n,d=d}\\(n,d)<-diag2 [0:[i\\j<-[1..],i<-[j,~j]]] [1..]|gcd n d==1]
