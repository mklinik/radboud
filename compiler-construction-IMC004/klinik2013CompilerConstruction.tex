...
accompany this document.  Each example is given in an .spl file.  The
\emph{print} function prints its argument as integer, followed by a newline.
The output of the program is given here, with newlines replaced by spaces.
...
\begin{description}
  ...
  \item[list-of-tuples.spl] Zip turns a tuple of lists into a list of tuples,
  while unzip does the opposite. Output:
  \begin{verbatim}
  4 3 3 100
  \end{verbatim}
