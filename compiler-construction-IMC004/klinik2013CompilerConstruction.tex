...
Every value in SPL is occupies one machine word on the stack.  Integers and
...
stack.  Functions are kept on the stack as memory addresses.

All parameters to functions are passed \emph{by value}, that is each parameter
