...
\subsubsection{Access to local variables}
...
\subsubsection{Access to global variables}
...
We solve this problem by storing the initial value of the stack pointer, as the
