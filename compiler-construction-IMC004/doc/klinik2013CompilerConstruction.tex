...
languages like Java and C++, this subtype relation has to be made explicit by
the programmer by declaring one class a subclass of another.  Contrast this with
how dynamically checked languages like Python work, where arbitrary objects can
be used in any context, as long as they bring all the fields that are accessed
in this context.  Otherwise, a runtime error occurs.  No explicit relation
between the classes of objects is required.
...
Records are eliminated by an operation called \emph{projection}, denoted by a
...
\subsection{Grammar for records}
