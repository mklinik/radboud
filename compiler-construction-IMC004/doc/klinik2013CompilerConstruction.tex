...
fresh type variables that arise in a type derivation, make constraints which
...
an error otherwise.  Resulting types may have type variables left, in which case
these types are polymorphic.

Wand \cite{Wand87b} proposes a similar idea for type checking record types.
