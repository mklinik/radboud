...
subtyping behaviour informally discribed in section \ref{sec_records}.  In this
section, we look at these properties in a more formal way.  The notion of
subtyping does not only refer to record types, but it transfers to the other
type constructors too, that is: lists, tuples and functions.
...
Wand's row-polymorphism.

Milners let-polymorphism.
